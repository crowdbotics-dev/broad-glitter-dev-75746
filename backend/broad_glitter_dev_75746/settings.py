"""
Django settings for broad_glitter_dev_75746 project.
...
ROOT_URLCONF = 'broad_glitter_dev_75746.urls'
...
WSGI_APPLICATION = 'broad_glitter_dev_75746.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broad_glitter_dev_75746 API",
    "DESCRIPTION": "API documentation for broad_glitter_dev_75746 App",
    "VERSION": "v1",
}
